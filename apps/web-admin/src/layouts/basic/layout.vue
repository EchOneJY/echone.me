...
import type { MenuRecordRaw } from '#/menu-record';

import { computed, useSlots, watch } from 'vue';

import { Toaster, VbenBackTop, VbenLogo } from '@echone-core/shadcn-ui';

import { useWatermark } from '@/hooks/core';
import { $t } from '@/locales';
import { useLockStore, useUserStore } from '@/stores';
...
import { VbenAdminLayout } from './layout';
import {
  LayoutExtraMenu,
  LayoutMenu,
  LayoutMixedMenu,
