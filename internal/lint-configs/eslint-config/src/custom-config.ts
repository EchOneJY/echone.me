...
const customConfig: Linter.Config[] = [
          ...
          patterns: [
            {
              group: ['@echone/*'],
              message:
                'The @core package cannot import the @echone package, please use the @core package itself',
            },
          ],
        },
      ],
  ...
  {
    // @core/shared内部组件，不能引入@echone/* 或者 @echone-core/* 里面的包
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@echone/*', '@echone-core/*'],
              message:
                'The @echone-core/shared package cannot import the @echone package, please use the @core/shared package itself',
            },
          ],
        },
      ],
